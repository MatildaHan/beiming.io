...
(function() {
    ...
    var BANNER_CONFIG = {
        ...
        random: {
            ...
            blurMin: 6,
            blurMax: 14,
            baseScaleMin: 1.1,   // ★ 基准放大 20%（1.2 上下浮动）
            baseScaleMax: 1.4
        },
    ...
    var bannerState = {
        ...
        fixedFragments: {},
        fixedRevealed: {},
        shuffledIds: null,       // 一次性乱序的 24 个 id
        wheelLock: false,
    ...
    function initBannerFragments() {
        ...
        function setRandomState(el) {
            ...
            // ★ 基准放大 20%，在 baseScaleMin~baseScaleMax 之间
            var s = rg.baseScaleMin + Math.random() * (rg.baseScaleMax - rg.baseScaleMin);
